...
if __name__ == '__main__':
    ...
    train_dl = DataLoader(
        EnergyDataset(data_scaled[:n_train], SEQ_LEN, PRED_HORIZON),
        batch_size=BATCH_SIZE, shuffle=True, drop_last=True
    )
    val_dl = DataLoader(
        EnergyDataset(data_scaled[n_train:n_train+n_val], SEQ_LEN, PRED_HORIZON),
        batch_size=BATCH_SIZE, shuffle=False
    )
    test_dl = DataLoader(
        EnergyDataset(data_scaled[n_train+n_val:], SEQ_LEN, PRED_HORIZON),
        batch_size=BATCH_SIZE, shuffle=False
    )
